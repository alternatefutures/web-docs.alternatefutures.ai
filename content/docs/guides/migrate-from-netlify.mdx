...
1. **An Alternate Futures account** -- [Sign up at clouds.alternatefutures.ai](https://clouds.alternatefutures.ai)
...
<Callout type="info" title="SPA Redirects">
...
<Callout type="warn" title="Netlify DNS Users">
