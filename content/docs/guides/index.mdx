...
| | Best for |
|---|---|
| **Web app** at [app.alternatefutures.ai](https://app.alternatefutures.ai) | Deploying from templates, watching services, managing billing and team members. See the [Web app overview](/guides/dashboard). |
