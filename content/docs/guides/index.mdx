...
| | Best for |
|---|---|
| **Web app** at [clouds.alternatefutures.ai](https://clouds.alternatefutures.ai) | Deploying from templates, watching services, managing billing and team members. See the [Dashboard tour](/guides/dashboard). |
...
AI agents can drive all three. See [AI tools and automation](/ai-agents).
...
[Organizations and projects](/guides/account-model); more terms are
in the [glossary](/guides/glossary).

## Get started

<Cards>
  <Card title="1. Sign in" href="/guides/authentication">
    Create your account with email or an Ethereum wallet.
  </Card>
  <Card title="2. First deployment with the CLI" href="/guides/quickstart">
    Install the CLI, deploy a container, and check that it is running.
  </Card>
  <Card title="3. Dashboard tour" href="/guides/dashboard">
    Find your projects, services, billing, and account settings in the web app.
  </Card>
</Cards>
