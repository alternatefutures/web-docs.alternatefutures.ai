...
of renting servers from one company, your workloads run on independent providers
(Akash for general compute, Phala for confidential computing, Spheron for GPUs)
through one account, one bill, and one set of tools.
...
| | Best for |
|---|---|
| **Web app** at [app.alternatefutures.ai](https://app.alternatefutures.ai) | Deploying from templates, watching services, managing billing and team members. |
...
services run. Set a budget to cap spend. Details are in
[Billing and usage](/guides/billing).
...
More terms are in the [glossary](/guides/glossary).
