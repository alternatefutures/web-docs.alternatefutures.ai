---
title: "Observability and APM"
description: "Monitor your applications with distributed tracing, metrics, and logging. The Alternate Futures Observability platform provides full APM (Application Performanc"
---
...
<Tabs items={["Query Traces","Get Trace Details","Query Logs","Query Metrics","Service Statistics"]}>
<Tab value="Query Traces">
...
<Tabs items={["List Traces","Get Trace Details","Query Logs","Service Statistics","Check Usage & Cost","View/Update Settings"]}>
<Tab value="List Traces">
...
<Tab value="View/Update Settings">
