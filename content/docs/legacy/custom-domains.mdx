---
title: "Custom domains (archived)"
description: "Archived guide from the retired sites product: how domains were attached to sites. Custom domains for Alternate Clouds services are not available yet."
---

<Callout type="warn" title="Archived: not available today">
This page describes the domain flow of the retired sites product (site IDs,
IPFS gateways, site verification records). Custom domains for Alternate Clouds
services are not available yet and none of these steps work on the current
platform. The page is kept for reference and will be replaced when the feature
ships. See [What changed from af](/legacy).
</Callout>

Bring your own domain from any registrar (GoDaddy, Namecheap, Cloudflare, etc.) and point it to your Alternate Clouds services.
...
- [Projects](/guides/projects) - Organize services and members
- [Troubleshooting](/troubleshooting) - DNS and certificate issues
- [Quick start](/guides/quickstart) - Deploy a service to point a domain at
