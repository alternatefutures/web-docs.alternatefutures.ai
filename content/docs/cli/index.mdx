...
|-------|----------|--------------|
| Account | `login`, `logout`, `whoami`, `orgs` | Authentication, organizations, your own model-provider keys |
...
| Swarms | `init`, `add`, `create`, `agents`, `swarms`, `run`, `tasks`, `secrets`, `models` | Build, deploy, and talk to a team of agents. See [Deploy a swarm of agents](/guides/deploy-a-swarm). |
