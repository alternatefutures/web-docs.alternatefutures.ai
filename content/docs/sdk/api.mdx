...
description: "Complete API reference for the @alternatefutures/sdk package. This page documents all public types, interfaces, and classes available in the SDK."
---
