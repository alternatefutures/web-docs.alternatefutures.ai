...
description: "Complete guide to installing and configuring the Alternate Futures SDK."
---
...
**Get your token:**
1. Log in to [clouds.alternatefutures.ai](https://clouds.alternatefutures.ai)
